                    ...
                    {step === 1 && (
                        <div className="space-y-5">
                            ...
                            <div className="grid gap-4 lg:grid-cols-2">
                                <CheckboxGroup label="Status" options={['Interested', 'Not Interested', 'Not Relevant', 'Not Picking', 'High expectation', 'Long Notice period', 'Location Not suitable', 'Shortlisted']} values={filters.status} onToggle={(value) => toggleFilter('status', value)} />
