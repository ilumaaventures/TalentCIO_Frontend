...
const Topbar = ({ toggleSidebar }) => {
    ...
    const handleProfileTabNavigate = (tabId) => {
        setShowProfileMenu(false);
                ...
                <div className="flex items-center gap-4 ml-auto">
                    ...
                    >
                        <button
                            ...
                            className="w-8 h-8 overflow-hidden bg-indigo-100 text-indigo-700 rounded-full flex items-center justify-center font-bold text-xs shadow-inner border border-indigo-200 transition-colors hover:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-200"
